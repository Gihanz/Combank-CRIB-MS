...
@Data
@Entity
@Table(name = "CRIB_CORP_CREDIT_FACILITY_DETAILS_LAST_24_MONTHS")
public class CorpCreditFacilityDetailsLast24Months extends Auditable {
