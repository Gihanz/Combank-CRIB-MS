...
@Data
@Entity
@Table(name = "CRIB_CONS_POTENTIAL_AND_CURRENT_LIABILITIES_HEADER")
public class ConsPotentialAndCurrentLiabilitiesHeader extends Auditable {
